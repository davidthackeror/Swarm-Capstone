...
class Orc extends Warrior{
    ...
    Orc(int minHealth, int maxHealth, int minSpeed, int maxSpeed, int minCourage, int maxCourage, int size, int minAttack, int maxAttack){
        ...
        this.setxPos(1);
        this.setyPos(1);
        this.setHealth(orcStats[0]);
        this.setAttack(Army.getRandomNumberInRange(orcStats[1], orcStats[2]));
        this.setSpeed(Army.getRandomNumberInRange(orcStats[3], orcStats[4]));
        this.setCourage(Army.getRandomNumberInRange(orcStats[5], orcStats[6]));
        this.setSize(orcStats[7]);
        this.setRange(orcStats[8]);
    }
